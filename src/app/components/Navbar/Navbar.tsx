    ...
    {!user ? 
      <>
        ...
        <div className='navbar-end gap-3'>
          <Link href={"/login#login"} className="btn rounded-2xl bg-[#B392AC] hover:bg-[#D1B3C4] border-0 text-xl text-[#735D78] font-bold">Login</Link>
            <span className='text-[#735D78] font-bold'>
              /
            </span>
          <Link href={"/login#signup"} className="btn rounded-2xl bg-[#B392AC] hover:bg-[#D1B3C4] border-0 text-xl text-[#735D78] font-bold">Sign Up</Link>
          {/* <SideMenu/> */}
        </div>
        )}
      </>
