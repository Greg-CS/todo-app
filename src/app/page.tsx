    ...
    <main>
        ...
        <div className="min-h-screen bg-[#D1B3C4]">
          <div className="text-center items-center grid pt-36">
            ...
            <h2 className="text-2xl pt-4 text-[#735D78] font-corethan-bold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 p-10">
            {itemsforcards.map((item) => (
              <div key={item.id} className="p-4">
                <div className="bg-[#735D78] p-6 h-[25vh] lg:h-[30vh] rounded-lg shadow-lg">
                  <h3 className="text-3xl font-bold text-[#F7D1CD]">{item.title}</h3>
                  <p className="text-2xl text-[#B392AC] pt-2">{item.description}</p>
                </div>
              </div>
            ))}
          </div>
